...
WORD_LIST = [
    ...
    'cultural', 'culture', 'cup', 'current', 'customer', 'dark', 'data', 
    ...
    'election', 'else', 'employee', 'end', 'energy', 'enjoy', 'enough', 
    ...
    'exist', 'expect', 'experience', 'expert', 'explain', 'eye', 'face', 
    'fact', 'factor', 'fail', 'fall', 'family', 'far', 'fast', 'father', 
    'fear', 'federal', 'feel', 'feeling', 'few', 'field', 'fight', 'figure', 
    'fill', 'film', 'final', 'finally', 'financial', 'find', 'finding', 
    ...
    'it', 'item', 'its', 'itself', 'job', 'join', 'just', 'keep', 'key', 
    'kid', 'kill', 'kind', 'kitchen', 'know', 'knowledge', 'land', 'language', 
    'large', 'last', 'late', 'later', 'laugh', 'law', 'lawyer', 'lay', 
    'lead', 'leader', 'learn', 'least', 'leave', 'left', 'leg', 'legal', 
    'less', 'let', 'letter', 'level', 'lie', 'life', 'light', 'like', 
    'likely', 'line', 'list', 'listen', 'little', 'live', 'local', 'long', 
    'look', 'lose', 'loss', 'lot', 'love', 'low', 'machine', 'magazine', 
    ...
    'seek', 'seem', 'sell', 'send', 'senior', 'sense', 'series', 'serious', 
    'serve', 'service', 'set', 'seven', 'several', 'sex', 'sexual', 'shake', 
    'share', 'she', 'shoot', 'short', 'shot', 'should', 'shoulder', 'show', 
    'side', 'sign', 'significant', 'similar', 'simple', 'simply', 'since', 
    'sing', 'single', 'sister', 'sit', 'site', 'situation', 'six', 'size', 
    'skill', 'skin', 'small', 'smile', 'so', 'social', 'society', 'soldier', 
    'some', 'somebody', 'someone', 'something', 'sometimes', 'son', 'song', 
    ...
    'way', 'we', 'weapon', 'wear', 'week', 'weigh', 'well', 'west', 'western', 
    'what', 'whatever', 'when', 'where', 'whether', 'which', 'while', 'white', 
    'who', 'whole', 'whom', 'whose', 'why', 'wide', 'wife', 'will', 'win', 
...
def random_english_text(max_num_sentences=3, min_words_per_sentence=8, max_words_per_sentence=41):
    """
    Generates random English text, similar to Calibre's functionality for Kindle emails.
    """
    ...
    def sentence():
        ...
        return ' '.join(random.choice(WORD_LIST) for _ in range(num_words)).capitalize() + '.'
        
    return ' '.join(sentence() for _ in range(num_sentences))

# --- Calibre's email creation logic ---
